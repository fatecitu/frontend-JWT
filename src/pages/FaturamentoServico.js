...
import { getFaturamentoServico } from '../resources/api/API'
...
*/
  ...
  const colunas = [
...

    {
      ...
      width: 100,
      defaultSortOrder: 'descend',
      sorter: (a, b) => a.cnpjCPF - b.cnpjCPF
    },
    {
      title: 'Inclusão',
  ...
  async function obtemFaturamento() {
    setCarregando(true)
    let res = await getFaturamentoServico()
    ...
    <Row gutter={[8, 0]}>
      <Col xs="24" xl={24}>
        <Card
          ...
          title="📈 Dados do Faturamento de Serviço (Notas Fiscais)"
          extra={
            <>
